...
NAV2D.Navigator = function(options) {
  ...
  function sendGoal(pose) {
    ...
    var goalMarker = new ROS2D.NavigationArrow({
      size : 5, // prima era 15
      strokeSize : 0.1, // prima era 1
      fillColor : createjs.Graphics.getRGB(0, 0, 255, 0.66), // prima era (255, 64, 128, 0.66)
      pulse : true
    });
    ////////////////////////////////////////////////////////////////////////////
    goalMarker.visible = false;
    this.rootObject.addChild(goalMarker);
    ...
    poseListener.subscribe(function(goal_pose) {
      // update the robots position on the map
      goalMarker.x = goal_pose.position.x;
      goalMarker.y = -goal_pose.position.y;
      if (!initScaleSet) {
      ...
      // change the angle
      goalMarker.rotation = stage.rosQuaternionToGlobalTheta(goal_pose.orientation);
...
NAV2D.OccupancyGridClientNav = function(options) {
  ...
  this.rootObject = options.rootObject || new createjs.Container();
  this.viewer = options.viewer;
  this.withOrientation = true // options.withOrientation || false;
